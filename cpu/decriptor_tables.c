...
**************for GDT*******************
****************************************/
/*null, kernel code and data seg, user code and data seg*/
...
static void init_gdt(){
    ...
    gdt_ptr.base = (uint32_t)&gdt_entries; //TODO (uint32_t)&gdt_entries
    ...
    //load gdt and set cs, ds... segment register
